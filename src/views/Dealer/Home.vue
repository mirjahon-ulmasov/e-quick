      ...
      <span class="date">
            ...
            >
              <template slot="thead">
                ...
                <vs-th sort-key="Наименование_онлайн_савдо" style="border-left: 2px solid #3A9FD1 !important; border-right: 2px solid #3A9FD1 !important;" >Наименования</vs-th>
                <vs-th sort-key="Завод" style="border-right: 2px solid #3A9FD1 !important;">Количество</vs-th>
              ...
              <template slot-scope="{ data }" class="scr">
                <tbody>
                  ...
                  >
                    ...
                    <vs-td style="border-left: 2px solid #3A9FD1 !important; border-right: 2px solid #3A9FD1 !important;">
                      <p>{{ tr.username }}</p>
                    </vs-td>
...
color: rgba(58, 159, 209, 1) !important;
    ...
    // display: block;
    // position: absolute;
    // background: url("~@/assets/dealer/img/icons/down.svg");
    // background-repeat: no-repeat;
    //                 background-position: 5%;
    //             background-size: 7%;
    //   // flex-direction: row;
