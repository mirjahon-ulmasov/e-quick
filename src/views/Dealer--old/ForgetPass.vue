  ...
  <div class="wrapper">
    <div class="container">
      <img
        ...
        src="@/assets/images--old/login/logo.png"
        alt=""
      />
...
div.wrapper {
  ...
  margin: 0;
  padding: 0;
  background-image: url("../../assets/images--old/login/login-background.svg"),
  ...
  div.container {
    ...
    input.custom-input1 {
      ...
      &:nth-child(3) {
        background-image: url("../../assets/images--old/icons/email.svg");
        background-repeat: no-repeat;
    ...
    input.custom-input2 {
      ...
      &:nth-child(4) {
        background-image: url("../../assets/images--old/icons/code.svg");
        background-repeat: no-repeat;
        background-position: 5%;
        background-size: 7%;
      }
