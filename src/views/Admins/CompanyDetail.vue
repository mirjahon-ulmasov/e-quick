    ...
    <div class="user-profile" >
      <div class="user-header">
        <div class="user-header__first">
          <img src="../../assets/images/icons/company-bold.svg" width="130px" alt="user icon" />
          <div class="user-name">
      ...
      <div class="user-details">
        <div class="user-detail">
          ...
          <h4 v-if="company.company.options === null" style="color: #58dfb6">-</h4>
          <h4 v-else style="color: #841549">Неактивен</h4>
        </div>
          <div class="user-detail">
          <p>Адрес</p>
          <h4 v-if="company.company.options === null" style="color: #58dfb6">-</h4>
...
export default {
  ...
  computed: {
    company() {
      return this.$store.state.addUser.company_id;
    },
  },
  destroyed(){
   this.company = null
  ...
  created() {
    this.$store.dispatch("addUser/fetchCompanyID", this.id);
  },
};
</script>
