<template>
    <div class="wrapper" >
      ...
      <div class="close-side" :class="active ? 'close-side' : 'close-side-none'"
       @click="active=!active" 
      >
      <img src="@/assets/images--old/icons/arrow.svg" v-if="!active"  style="color: #cfcfcf; border-radius: 2px; margin-right: 5px" class="cursor-pointer" alt="cvxzv">
      <img src="@/assets/images--old/icons/arrow2.svg" v-else  style="color: #cfcfcf; border-radius: 2px" class="cursor-pointer" alt="cvxzv">
    </div>
    </div>
</template>
<script>
import SideBar from './dealer/Sidebar.vue'
export default {
  components:{
    SideBar,
  },
