  ...
  <div class="parentx">
    <vs-sidebar
      ...
      <div @mouseenter="mouseEnter" @mouseleave="mouseLeave">
        <!-- Header -->
        <div style="align-items: center !important" class="header-sidebar flex items-end justify-between" slot="header">
          <!-- Logo -->
...
<style lang="scss">
@import  "../../../assets/scss/style/variables";
